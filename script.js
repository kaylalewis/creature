var animal = ["ostrich","cat","parrot","octopus","eel","shark","rabbit","lizard","librarian","barista","mushroom","pizza","robot","ballerina","raccoon","spider","jellyfish","dinosaur","frog","rat","martini","astronaut","cactus","vacuum","antelope","clown","seahorse","turnip","kangaroo","pickle"];
var place = ["Mars","Ohio","the desert","Italy","Antarctica","Austin"];
var year = ["1924","2150","1500","4000","700 BC","1980","1960","1865"];
var activity = ["dancing","sleeping","running","singing","fighting","studious","yelling","vicious","presidential","laughing","stoic","nomad","drunk","jovial","mutant","lovesick","senial","classy","complicated","smart","romantic","frightened","tired","stressed","wild","neurotic","glamorous"];

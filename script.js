...
var activity = ["dancing","sleeping","running","singing","fighting","studious","yelling","vicious","presidential","laughing","stoic","nomad","drunk","jovial","mutant","lovesick","happy","senial","classy","complicated","smart","romantic","frightened","tired","stressed","wild","neurotic","glamorous","naive","mischievous","naughty","musical","flexible","shocked","foolish","perplexed","disinterested","compassionate","conscious","smug","veteran", "talkative","passionate","rude","lazy","determined","fearless","bossy","messy","popular","sweet","clumsy","grumpy","hungry","delicious","lonely","professional","talented","grim","wicked","wealthy","shy","curious","magical","boring","dramatic","ferocious","nervous","strong","graceful","reclusive","defiant","lucky","sentimental","suspicious","spiritual","broken","regal","busy","tropical","famous","cuddly","criminal","focused","dainty","creepy","prickly","heroic","jealous","insecure","philosophic","crafty","muscular","saintly","scientific","versatile","worldly","loitering","flying","traveling","baking","blushing","lying","scatterbrained"];
